...
public class BackupScreenshotController : MonoBehaviour
{
    ...
    private APIPythonUnityJsonFormat unityAPIInfo;
    ...
    {
        unityAPIInfo = JsonUtility.FromJson<APIPythonUnityJsonFormat>(receivedString);
